...
Работающие функции бота:
  ...
  - настраиваемая автопокупка предмета. По умолчанию покупаем Боевой нож, если хватает денег.
...
Команды боту от админа:<br />
    ...
    #enable_ab - Включить автопокупку<br />
    #disable_ab - Выключить авто покупку<br />
    #set_ab_gold_limit [number] - Установить лимит золота для старта покупки(Пример: #set_ab_gold_limit 100)<br />
    #set_ab_item [string] - Установить команду для покупки предмета<br />
